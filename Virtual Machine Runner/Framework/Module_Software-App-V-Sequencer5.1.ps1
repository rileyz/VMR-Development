...
# Script Assets ###################################################################################
# Asset: appv_sequencer_setup.exe
...
$Process = Start-Process -FilePath $VMRCollateral\appv_sequencer_setup.exe -ArgumentList '/q /AcceptEULA /CEIPOPTIN=0 /NoRestart' -Wait -PassThru
