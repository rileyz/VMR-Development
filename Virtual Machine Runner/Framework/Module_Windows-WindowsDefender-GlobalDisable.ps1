<#
.SYNOPSIS
    Disables Windows Defender globally.
...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender' -RegistryValueName 'DisableAntiSpyware' -RegistryValueData '1' -RegistryValueType 'DWord'
