<#
.SYNOPSIS
    Sets Windows Update to notify before download.
...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU' -RegistryValueName 'AUOptions' -RegistryValueData '2' -RegistryValueType 'DWord'
