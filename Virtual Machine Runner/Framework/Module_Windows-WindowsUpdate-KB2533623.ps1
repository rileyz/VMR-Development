<#
.SYNOPSIS
    Installs KB2533623, security advisory for PowerShell 3.
...
# Script Assets ###################################################################################
# Asset: Windows6.1-KB2533623-x64.msu
# Asset: Windows6.1-KB2533623-x86.msu
...
$ArrayScriptExitResult += (Start-Process -FilePath $KB2533623ForThisArchitecture -ArgumentList '/quiet /norestart' -Wait -PassThru).ExitCode
