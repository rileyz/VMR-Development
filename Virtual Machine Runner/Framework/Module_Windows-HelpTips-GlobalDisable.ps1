...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\EdgeUI' -RegistryValueName 'DisableHelpSticker' -RegistryValueData '1' -RegistryValueType 'DWord'
