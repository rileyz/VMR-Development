...
# Script Assets ###################################################################################
# Asset: AppV5.1RTM_Client_KB3198158.exe
...
$Process = Start-Process -FilePath $VMRCollateral\AppV5.1RTM_Client_KB3198158.exe -ArgumentList '/q /AcceptEULA /CEIPOPTIN=0 /MUOPTIN=0 /NoRestart' -Wait -PassThru
