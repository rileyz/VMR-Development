...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer' -RegistryValueName 'EnableAutoTray' -RegistryValueData '0' -RegistryValueType 'DWord'
