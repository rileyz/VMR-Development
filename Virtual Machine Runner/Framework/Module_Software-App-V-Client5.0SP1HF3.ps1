...
# Script Assets ###################################################################################
# Asset: AppV5.0SP1-Client-KB2897085.exe
...
$Process = Start-Process -FilePath $VMRCollateral\AppV5.0SP1-Client-KB2897085.exe -ArgumentList '/q /AcceptEULA /CEIPOPTIN=0 /MUOPTIN=0 /NoRestart' -Wait -PassThru
