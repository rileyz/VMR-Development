...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Personalization' -RegistryValueName 'NoLockScreen' -RegistryValueData '1' -RegistryValueType 'DWord'
