<#
.SYNOPSIS
    Disables first logon welcome screen and animation globally.
...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System' -RegistryValueName 'EnableFirstLogonAnimation' -RegistryValueData '0' -RegistryValueType 'DWord'
