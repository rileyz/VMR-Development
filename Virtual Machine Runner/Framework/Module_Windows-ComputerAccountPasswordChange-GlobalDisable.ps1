<#
.SYNOPSIS
    Disables the computer account password from changing globally.
...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SYSTEM\CurrentControlSet\Services\NetLogon\Parameters' -RegistryValueName 'DisablePasswordChange' -RegistryValueData '1' -RegistryValueType 'DWord'
