...
# Script Assets ###################################################################################
# Asset: AppV5.0SP2-Client-KB2956985.exe
...
$Process = Start-Process -FilePath $VMRCollateral\AppV5.0SP2-Client-KB2956985.exe -ArgumentList '/q /AcceptEULA /CEIPOPTIN=0 /MUOPTIN=0 /NoRestart' -Wait -PassThru
