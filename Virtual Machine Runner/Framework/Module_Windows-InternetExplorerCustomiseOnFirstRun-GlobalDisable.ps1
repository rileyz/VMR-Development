<#
.SYNOPSIS
    Disables Internet Explorer customise on first run globally.
...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Policies\Microsoft\Internet Explorer\Main' -RegistryValueName 'DisableFirstRunCustomize' -RegistryValueData '1' -RegistryValueType 'DWord'
