...
$Installer = "$VMRCollateral\InstEd-1.5.15.26.msi"

$ArrayScriptExitResult += (Start-Process msiexec.exe -ArgumentList "/i $Installer REBOOT=ReallySuppress /qn" -Wait -PassThru).ExitCode
