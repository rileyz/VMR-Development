<#
.SYNOPSIS
    Do not open Server Manager at logon for invoker of the script.
...
$ArrayScriptExitResult += Write-Registry -RegistryKey 'HKCU:\SOFTWARE\Microsoft\ServerManager' -RegistryValueName 'DoNotOpenServerManagerAtLogon' -RegistryValueData '1' -RegistryValueType 'DWord'
