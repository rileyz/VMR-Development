...
# Script Assets ###################################################################################
# Asset: appdeploy-repackager.msi
...
$ArrayScriptExitResult += (Start-Process msiexec.exe -ArgumentList "/i $Installer ALLUSERS=1 REBOOT=ReallySuppress /qn" -Wait -PassThru).ExitCode
