...
$ScriptExitResult = Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\OneDrive' -RegistryValueName 'DisableFileSyncNGSC' -RegistryValueData '1' -RegistryValueType 'DWord'
