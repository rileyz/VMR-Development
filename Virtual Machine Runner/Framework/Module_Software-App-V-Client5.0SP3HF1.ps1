...
# Script Assets ###################################################################################
# Asset: AppV5.0SP3_Client_KB3039022.exe
...
$Process = Start-Process -FilePath $VMRCollateral\AppV5.0SP3_Client_KB3039022.exe -ArgumentList '/q /AcceptEULA /CEIPOPTIN=0 /MUOPTIN=0 /NoRestart' -Wait -PassThru
