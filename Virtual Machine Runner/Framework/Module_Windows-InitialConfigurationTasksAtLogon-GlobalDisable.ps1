...
$ScriptExitResult = Write-Registry -RegistryKey 'HKLM:\SOFTWARE\Microsoft\ServerManager\Oobe' -RegistryValueName 'DoNotOpenInitialConfigurationTasksAtLogon' -RegistryValueData '1' -RegistryValueType 'DWord'
