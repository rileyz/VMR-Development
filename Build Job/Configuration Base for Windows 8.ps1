...
Write-Output 'Installing Windows 8 updates via WSUSOffline.'
...
Write-Output 'Configure Windows Services: BaseConfiguration_Windows8.csv.'
VMR_RunModule -Module Framework\Module_Windows-Services-GlobalConfigure.ps1 -Arguments '-WindowsServicesCSV BaseConfiguration_Windows8.csv'

Write-Output 'Configure Windows Task Schedules: BaseConfiguration_Windows8.csv.'
VMR_RunModule -Module Framework\Module_Windows-TaskScheduler-GlobalConfigure.ps1 -Arguments '-TaskSchedulesCSV BaseConfiguration_Windows8.csv'
