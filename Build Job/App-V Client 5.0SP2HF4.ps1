# Start Application Virtualization 5.0 Client with Service Pack 2 Hotfix 4 Build ##################
...
Write-Output 'Installing Application Virtualization 5.0 Client with Service Pack 2, Hotfix 4.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.0SP2HF4.ps1
...
#<<< End of Application Virtualization 5.0 Client with Service Pack 2 Hotfix 4 Build >>>
