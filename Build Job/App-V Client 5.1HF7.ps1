# Start Application Virtualization 5.1 Client with Hotfix 7 Build #################################
...
Write-Output 'Installing Application Virtualization 5.1, Hotfix 7.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.1HF7.ps1
...
#<<< End of Application Virtualization 5.1 Client with Hotfix 7 Build >>>
