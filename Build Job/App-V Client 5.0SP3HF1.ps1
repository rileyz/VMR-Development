# Start Application Virtualization 5.0 Client with Service Pack 3 Hotfix 1 Build ##################
...
Write-Output 'Installing Application Virtualization 5.0 Client with Service Pack 3, Hotfix 1.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.0SP3HF1.ps1
...
#<<< End of Application Virtualization 5.0 Client with Service Pack 3 Hotfix 1 Build >>>
