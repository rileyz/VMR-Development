...
Write-Output 'Installing Application Virtualization 5.0 Client with Service Pack 2, Hotfix 5.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.0SP2HF5.ps1
