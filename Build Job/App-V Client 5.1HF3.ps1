# Start Application Virtualization 5.1 Client with Hotfix 3 Build #################################
...
Write-Output 'Installing Application Virtualization 5.1, Hotfix  3.'
VMR_RunModule -Module Framework\Module_Software-App-V-Client5.1HF3.ps1
...
#<<< End of Application Virtualization 5.1 Client with Hotfix 4 Build >>>
